...
<form action="/lantaitestdelete/delete" method="post">
    {{ csrf_field() }}
<div class="badan"> 
...
<div class="isi">       
    <!--Cetak Slot Lantai -->
        ...
        @foreach($slot as $sub)
                    ...
                    <a href="/slotparkir/{{$sub->id}}"><div class="kotak">{{$sub->Nama_Slot}}</div></a>
                    @elseif($sub->Status_Slot == 2)
                    <div class="kotak1"><input type="checkbox" name="knk[]" value="{{$sub->id}}"></div>                   
